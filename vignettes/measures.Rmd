---
title: "Similarity and Distant Measures in proxyC"
author: "Kohei Watanabe"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Similarity and Distant Measures in proxyC}
...
This vignette explains the similarity and distance measures are computed in **proxyC**.
