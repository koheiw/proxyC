...
Masking has the greatest impact on execution time in other methods because **proxyC** computes and saves Dice coefficients only for unmasked pairs. We expect to see similar performance improvement in "jaccard", "ejaccard", "fjaccard", "edice", "hamann", "faith" and"simple matching".
